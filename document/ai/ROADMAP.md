...
| F-QA | 质量收敛与加固(deterministic 审计/门禁/类型不变量/修债) | 🔄 进行中(2026-06-20 立项,feat/f-qa,全包 Q1-Q4):Q1 零成本门禁+CI 矩阵 / Q2 deterministic 审计方法论+D13 D14 新维度 / Q3 系统审计抓潜在问题 / Q4 头号高危债收敛(RefCount+UserPtr+DEBT-001/003/004)。来源 6-agent workflow(Linux 全谱/现代 C++/维度 gap/仓库实证/综合/critic)。详见 PLAN「🔄 F-QA」段 |
