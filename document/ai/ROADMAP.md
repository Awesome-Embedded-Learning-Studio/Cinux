...
| F-QA | 质量收敛与加固(deterministic 审计/门禁/类型不变量/修债) | 🔄 进行中:F-QA Q1✅合 main(PR#25) / Q2+Q3+DEBT-017✅合 main(PR#26,14/14 审计+host-ASAN 门禁) / **Q4a✅**(RefCount+UserPtr 类型先行,feat/f-qa-q4 待 PR) / Q4b-e 待(DEBT-002/003/006/001/004/005;Q4e 最险单独 propose)。(2026-06-20 立项)来源 6-agent workflow(Linux 全谱/现代 C++/维度 gap/仓库实证/综合/critic)。详见 PLAN「🔄 F-QA」段 |
