...
| F6 | VFS/文件系统 | M1 VFS增强+mount⏳ M2 ProcFS🔄(进程自省:/proc 根 readdir 枚举 pid + /proc/<pid>/{stat,cmdline} 动态伪文件,2026-06-30 立项;照抄 DevFs 范式) M3 DevFS✅(基础节点 null/zero/console + /dev 挂载,2026-06-30) M4 tmpfs⏳ M5 ext4⏳ M6 ext2独立库⏳ | Dentry Cache/5 FS/mount |
| F7 | 网络协议栈 | M1 以太网✅ M2 ARP✅ M3 IPv4/ICMP✅（2026-06-26 真 ping 10.0.2.2 干通,底子优先 L0-L3:netdev 抽象+loopback 确定性打底→e1000 收尾） M4 UDP✅（2026-06-30,协议层+端口多路复用+Ipv4Module L4 proto 表(ICMP 迁入);host 单测+loopback round-trip+e1000 TX smoke,feat/f7-m4-udp 已合 main PR#47） M5 TCP⏳ M6 Socket⏳ | TCP/IP+Socket API |
