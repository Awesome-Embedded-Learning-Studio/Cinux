...
|---|------|--------------------|---------|
| F1 | 内核基础设施 | M0 核心类型 ✅(类型就绪,Cinux-Base)→🔄 ErrorOr 消费迁移(批1+2a✅,批2b🔄); M1 RingBuffer ⏳; M2 日志 ⏳; M3 DMA ⏳; M4 块设备 ⏳ | ErrorOr/StringView/Span/IBlockDevice/dmesg/DMA Pool |
...
## 当前焦点
**F1-M0 ErrorOr 消费迁移** — 批级进度见 `PLAN.md`。
