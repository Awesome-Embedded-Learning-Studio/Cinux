...
| F8 | IPC 扩展 | M1 Pipe增强✅(BrokenPipe/SIGPIPE+真调度阻塞替 sti/hlt+O_NONBLOCK) M2 FIFO✅(FifoRegistry+FifoOps cloning+sys_mknod/mkfifo,2026-06-30) M3 Unix Socket✅(AF_UNIX Socket 适配器+内存 UnixRegistry+字节流 round-trip,2026-07-01 集成线待 push) M4 共享内存⏳ M5 epoll⏳ | CV/PTY/shm/epoll |
