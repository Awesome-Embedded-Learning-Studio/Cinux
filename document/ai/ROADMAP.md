...
| F6 | VFS/文件系统 | M1 VFS增强+mount⏳ M2 ProcFS✅(进程自省:/proc 根 readdir 枚举 pid + /proc/<pid>/{stat,cmdline} 动态伪文件,照抄 DevFs 范式;定长 pid 索引 inode 池 + signal_nth_task_pid 纯增量 accessor;2026-06-30) M3 DevFS✅(基础节点 null/zero/console + /dev 挂载,2026-06-30) M4 tmpfs🔄(批1 TmpFs 类+机制测✅ commit 6656096;boot 挂 /tmp + mount/umount2 留批2) M5 ext4⏳ M6 ext2独立库⏳ | Dentry Cache/5 FS/mount |
