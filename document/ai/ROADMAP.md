...
| F-CLN | 债务清理（xHCI 审补全 + 修 open 债） | 🔄 立项(2026-06-25,feat/f-cln-debt):批0 xHCI/USB 专项审 + 批1-7 修 DEBT-015/016/018/008/009/010/007 + 批8 收尾。DEBT-019/013/020/012 留 F10 顺手。详见 PLAN「🔄 F-CLN」段 |

## 当前焦点
**F-CLN 债务清理 🔄 立项（2026-06-25，feat/f-cln-debt）**：开 F10/F7 大弧前收敛 [debt.md](todo/quality/debt.md) open 债 + xHCI/USB 审计补全（Q3 后合入未审面）。批0-8（DEBT-015/016/018/008/009/010/007 + xHCI 审）。详见 PLAN「🔄 F-CLN」段。
