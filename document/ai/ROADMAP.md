...
| F6 | VFS/文件系统 | M1 VFS增强+mount⏳ M2 ProcFS✅(进程自省:/proc 根 readdir 枚举 pid + /proc/<pid>/{stat,cmdline} 动态伪文件,照抄 DevFs 范式;定长 pid 索引 inode 池 + signal_nth_task_pid 纯增量 accessor;2026-06-30) M3 DevFS✅(基础节点 null/zero/console + /dev 挂载,2026-06-30) M4 tmpfs⏳ M5 ext4⏳ M6 ext2独立库⏳ | Dentry Cache/5 FS/mount |
...
| F8 | IPC 扩展 | M1 Pipe增强✅(BrokenPipe/SIGPIPE+真调度阻塞替 sti/hlt+O_NONBLOCK) M2 FIFO✅(FifoRegistry+FifoOps cloning+sys_mknod/mkfifo,2026-06-30) M3 Unix Socket✅(AF_UNIX Socket 适配器+内存 UnixRegistry+字节流 round-trip,2026-07-01 集成线待 push) M4 共享内存⏳ M5 真 poll/select✅(替 stub:阻塞+wait-queue+定时唤醒+sys_select(23),2026-07-01 worktree `feat/f8-m5-real-poll` 待 push) | CV/PTY/shm/epoll |
